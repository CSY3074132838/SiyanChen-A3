...
--  Seed Data: events
INSERT INTO events
(org_id, category_id, title, short_desc, full_desc, city, venue, address,
 start_time, end_time, hero_image_url, status, goal_amount, raised_amount, latitude, longitude)
VALUES
(1, 1, 'Stars for Scholars Gala', 'Black-tie dinner to fund scholarships.',
 ...
 'https://images.unsplash.com/photo-1543007630-9710e4a00a20', 'active', 50000.00, 12000.00, 35.6749, 139.7595),
...
(1, 2, 'Run for Young Minds 10K', 'Community 5K/10K fun run.',
 ...
 'https://images.unsplash.com/photo-1520975922203-b88663a1b0d4', 'active', 20000.00, 4600.00, 35.6275, 139.7768),
...
(2, 3, 'Art for Trees Silent Auction', 'Bid on local art to plant trees.',
 ...
 'https://images.unsplash.com/photo-1519710164239-da123dc03ef4', 'active', 15000.00, 3000.00, 35.6591, 139.7004),
...
(2, 4, 'Sounds of the City Benefit Concert', 'Indie bands unite for greener streets.',
 ...
 'https://images.unsplash.com/photo-1518972559570-7cc1309f3229', 'active', 30000.00, 0.00, 35.6728, 139.6949),
...
(1, 2, 'Family Fun Run (5K)', 'All ages welcome. Strollers OK!',
 ...
 'https://images.unsplash.com/photo-1502810190503-8303352d0aa0', 'active', 8000.00, 7800.00, 35.7106, 139.8017),
...
(1, 1, 'Hope Spring Gala 2024', 'Last year’s gala (past event).',
 ...
 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f', 'active', 45000.00, 45000.00, 35.6812, 139.7671),
...
(2, 3, 'Vintage Vinyl Auction', 'Rare LPs for a greener city.',
 ...
 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4', 'active', 12000.00, 11200.00, 35.7074, 139.6658),
...
(2, 4, 'Rooftop Jazz Night', 'Suspended: pending policy review.',
 ...
 'https://images.unsplash.com/photo-1511193311914-0346f7f2fd1d', 'suspended', 10000.00, 0.00, 35.6717, 139.7651);

--  Seed Data: tickets
INSERT INTO tickets (event_id, name, price) VALUES
(1, 'Gala Standard', 120.00),
(1, 'Gala VIP', 250.00),
(2, '10K Entry', 25.00),
(2, '5K Entry', 15.00),
...
--  Seed Data: registrations (10 records)
